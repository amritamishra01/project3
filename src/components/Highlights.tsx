...
const testimonials = [
  {
    ...
    quote: "The scalability is unmatched. We migrated our entire infrastructure in less than 48 hours and saw a 300% performance boost immediately.",
    initials: "ER"
  },
  {
    name: "Marcus J.",
    role: "Lead Dev @ Orbit",
    quote: "Finally, a platform that understands modern development workflows. The AI integration saved us weeks of boilerplate coding.",
    initials: "MJ"
  },
  {
    name: "Sarah K.",
    role: "Founder @ Novalabs",
    quote: "The security features gave us the confidence to deploy sensitive healthcare data to the edge without a second thought. Truly game-changing.",
    initials: "SK"
  }
];
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Loved by <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Innovators</span>
          </h2>
          <p className="text-slate-400 max-w-xl mx-auto">
            Join thousands of developers and companies building the future with our technology.
          </p>
        </motion.div>
